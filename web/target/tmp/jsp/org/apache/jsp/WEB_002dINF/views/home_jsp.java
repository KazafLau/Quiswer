 ...
 * Generated at: 2016-11-05 12:18:38 UTC
...
return;
 ...
 for(User user:(List<User>)session.getAttribute("friendslist"))
      ...
      out.print(user.getUsername());
      out.write("\"/>\n");
      out.write("                          <input type=\"hidden\" name=\"friendID\" value=\"");
      out.print(user.getUserid());
      out.write("\"/>\n");
    ...
    if(requestmap.keySet().isEmpty()!=true)
    {
      ...
      out.write("    <tr>\n");
      out.write("        <th>");
      out.print(requestmap.get(request1));
      out.write("</th>\n");
      out.write("        <th>");
      out.print(request1.getRequest_message());
      out.write("</th>\n");
      out.write("        <th>");
      out.print(request1.getRequest_time());
      out.write("</th>\n");
...
Map<Question,String> questionmap=(Map<Question,String>)session.getAttribute("questionmap");
    if(questionmap.keySet().isEmpty()!=true){
      ...
      out.write("        <th>QuestionTime</th>\n");
      out.write("        <th>QuestionPrivacy</th>\n");
      ...
      out.write("    <tr>\n");
      out.write("        <th>");
      out.print(questionmap.get(question));
      out.write("</th>\n");
      out.write("        <th>");
      out.print(question.getQuestion_text());
      out.write("</th>\n");
      out.write("        <th>");
      out.print(question.getQuestion_time());
      out.write("</th>\n");
      out.write("        <th>");
      out.print(question.getQuestion_privacy());
      out.write("</th>\n");
      out.write("        <th><form method=\"post\" action=\"answer\">\n");
      out.write("            <input type=\"hidden\" name=\"questiontext\" value=\"");
      out.print(question.getQuestion_text());
      out.write("\">\n");
      out.write("            <input type=\"hidden\" name=\"questionID\" value=\"");
      out.print(question.getQuestion_id());
      out.write("\">\n");
